...
public class lvl20 : MonoBehaviour {
	...
	void Start () {
		...
		levelcomplete.text = "";
		deathcount = PlayerPrefs.GetInt ("Deaths19");
		done = 0;
	...
	IEnumerator EndLevel()
	{
		...
		SceneManager.LoadScene ("BeginningEnd");
		done = 1;
		savedeathcount ();
	...
	void savedeathcount()
	{
		PlayerPrefs.SetInt ("FinalDeathCountBeginning", deathcount);
