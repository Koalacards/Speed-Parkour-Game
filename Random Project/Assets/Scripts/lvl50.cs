...
public class lvl50 : MonoBehaviour {
	...
	IEnumerator EndLevel()
	{
		...
		SceneManager.LoadScene ("Scene51");
		savedeathcount ();
	...
	void savedeathcount()
	{
		PlayerPrefs.SetInt ("Deaths50", deathcount);
	}
	...
	void AddDeath()
	{
		...
		blockmovement.Play ("level 50 anim", 0, 0f);
	}
}