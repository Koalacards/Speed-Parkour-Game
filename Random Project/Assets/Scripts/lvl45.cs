...
public class lvl45 : MonoBehaviour {
	...
	void Start () {
		...
		deathcount = PlayerPrefs.GetInt("Deaths44");
	...
	void OnTriggerEnter2D(Collider2D other)
	{
		...
		if(other.CompareTag("Trigger"))
		{
			...
			clock = clock + 5;
			transform.position = new Vector2 (-8.47f, -4.46f);
		}
	...
	IEnumerator EndLevel()
	{
		...
		SceneManager.LoadScene ("Scene46");
		savedeathcount ();
	...
	void savedeathcount()
	{
		PlayerPrefs.SetInt ("Deaths45", deathcount);
	}
