...
public class lvl54 : MonoBehaviour {
	...
	void Start () {
		...
		deathcount = PlayerPrefs.GetInt("Deaths53");
		initialdeathcount = PlayerPrefs.GetInt("Deaths53");
	...
	void Update()
	{
		...
		if (initialdeathcount + 3 == deathcount) {
			hinttext.text = "Hint: This level is a lie.";
		}
	}
	...
	void savedeathcount()
	{
		PlayerPrefs.SetInt ("Deaths54", deathcount);
	}
