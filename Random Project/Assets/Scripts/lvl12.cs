...
public class lvl12 : MonoBehaviour {
	...
	void Start () {
		...
		levelcomplete.text = "";
		deathcount = PlayerPrefs.GetInt ("Deaths11");
		secretobject.gameObject.SetActive (false);
	...
	void OnTriggerEnter2D(Collider2D other)
	{
		...
		if (other.CompareTag ("Trigger")) {
			secretobject.gameObject.SetActive (true);
			other.gameObject.SetActive (false);
			clock = clock + 2;
		}
	}
	...
	void savedeathcount()
	{
		PlayerPrefs.SetInt ("Deaths12", deathcount);
	}
